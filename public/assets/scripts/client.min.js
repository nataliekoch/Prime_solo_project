...
app.controller("SearchController", [ "$scope", "$http", "$location", "apiService", "BreedCall", "SecondaryBreedSearch", function($scope, $http, $location, apiService, BreedCall, SecondaryBreedSearch) {
    ...
    $scope.searchResults = $scope.goToProfile = function(animalID, animalOrgId) {
    ...
    var urlConstructor = function(species, breed, zip, distance) {
        var filter = {
            ...
            search: {
                ...
                fields: [ "animalSecondaryBreed", "animalStatus", "animalID", "animalPictures", "animalSpecies", "animalBreed", "animalLocation", "animalLocationCitystate", "animalName", "animalOKWithAdults", "animalOKWithCats", "animalOKWithDogs", "animalOKWithKids", "animalSpecialneeds", "animalSex", "animalOrgID" ]
            }
        };
